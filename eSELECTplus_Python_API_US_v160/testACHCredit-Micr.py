...
chkInfo = USmpgClasses.ACHInfo(micr, dl_num, magstripe, image_front, image_back) ### When ACHInfo is obtained from MICR reader
#chkInfo = USmpgClasses.ACHInfo(sec, routing_num, account_num, account_type)

ach = USmpgClasses.ACHCredit (order_id, amount, chkInfo)
